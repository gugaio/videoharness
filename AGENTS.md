...
## Project plan
- See [`docs/PROJECT_PLAN.md`](docs/PROJECT_PLAN.md) for the product phases. Persistent HLS/DASH clones, multitrack capture, storage lifecycle and the ClearKey test MVP are implemented; Phase 5 tracks ingestion compatibility, live capture, key hardening, scale and playback E2E work.
