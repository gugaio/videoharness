...
from stream_lens.adapters.outbound.manifests.dash_parser import parse_dash
from stream_lens.adapters.outbound.manifests.hls_parser import parse_hls
...
class DeclarativeManifestInspector(ManifestInspectorPort):
    """Implementa o port com heurísticas de conteúdo (não só extensão)."""
