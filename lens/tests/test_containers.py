...
from stream_lens.parsers.fmp4 import parse_fmp4
from stream_lens.parsers.mpegts import parse_mpegts
...
class TestMpegTs:
    def test_stream_type_15_e_metadata_pes_nao_audio(self):
        from stream_lens.parsers.mpegts import _STREAM_KINDS
...
class TestFfprobe:
    def test_av_timing_usa_menor_pts_de_apresentacao_por_stream(self):
        from stream_lens.adapters.outbound.ffprobe import (
    ...
    def test_gop_parcial_nao_inventa_intervalo(self):
        from stream_lens.adapters.outbound.ffprobe import _summarize_gop
    ...
    def test_recusa_entrada_combinada_acima_do_limite(self, monkeypatch, tmp_path):
        import stream_lens.adapters.outbound.ffprobe as mod
    ...
    def test_resumo_preserva_cor_e_side_data_hdr_reconhecido(self):
        from stream_lens.adapters.outbound.ffprobe import _summarize
    ...
    def test_probe_de_fixture_fmp4(self):
        from stream_lens.adapters.outbound.ffprobe import FFprobeMediaProbe
