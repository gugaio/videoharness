...
- Captura de janela limitada (default de 10s; no mínimo dois segmentos de mídia
  por representação declarada quando há dois ou mais capturáveis, mesmo quando estende a
  janela; máximo de 60s).
