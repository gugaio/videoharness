...
export function App(): JSX.Element {
  ...
  function preventPlaceholderSubmit(event: FormEvent<HTMLFormElement>): void {
    ...
    <main className="relative min-h-screen overflow-hidden bg-harness-bg text-harness-text">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1180px] flex-col px-5 pb-10 pt-6 sm:px-8 lg:px-12">
        ...
        <section className="flex flex-1 flex-col justify-center py-16 sm:py-20">
          ...
          <form className="mx-auto mt-10 w-full max-w-3xl" onSubmit={preventPlaceholderSubmit}>
            ...
            />
            <button
              className="mt-5 h-14 w-full cursor-not-allowed rounded-2xl bg-harness-accent text-base font-semibold text-[#0a0c12] opacity-70"
              disabled
              type="submit"
            >
              Investigate
            </button>
            <p className="mt-3 text-xs text-white/35">The investigation pipeline is being connected in Phase 1.</p>
          </form>
